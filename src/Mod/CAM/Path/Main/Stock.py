...
class StockCreateCylinder(Stock):
    ...
    def execute(self, obj):
        print("StockCreateCylinder execute", obj.Radius, obj.Height, obj.Axis)
...
def CreateCylinder(job, radius=None, height=None, placement=None, axis=None):
    ...
    print("    axis", axis, "  radius", radius, "  height", height, "  placement", placement)
    base = _getBase(job)
    obj = FreeCAD.ActiveDocument.addObject("Part::FeaturePython", "Stock")
